...
class WDTIViewTwitter_integration{
  ...
  public function display() {
   ...
   $order_by = WDWTILibrary::get( 'order_by', 'order' );
        ...
        <thead>
          ...
          <th class="<?php if ($order_by == 'title') {echo $order_class;} ?>">
            <a onclick="spider_set_input_value('task', '');
                        ...
                        spider_set_input_value('asc_or_desc', '<?php echo (( WDWTILibrary::get('order_by','') == 'title' && WDWTILibrary::get('asc_or_desc') == 'asc') ? 'desc' : 'asc'); ?>');
                        spider_form_submit(event, 'spider_twitt_form')" href="">
          ...
          <th class="<?php if ($order_by == 'type') {echo $order_class;} ?>">
            <a onclick="spider_set_input_value('task', '');
                        ...
                        spider_set_input_value('asc_or_desc', '<?php echo (( WDWTILibrary::get('order_by','') == 'type' && WDWTILibrary::get('asc_or_desc') == 'asc') ? 'desc' : 'asc'); ?>');
                        spider_form_submit(event, 'spider_twitt_form')" href="">
          ...
          <th id="th_order" class="table_medium_col <?php if ($order_by == 'order') {echo $order_class;} ?>">
            <a onclick="spider_set_input_value('task', '');
                        ...
                        spider_set_input_value('asc_or_desc', '<?php echo (( WDWTILibrary::get('order_by','') == 'order' && WDWTILibrary::get('asc_or_desc') == 'asc') ? 'desc' : 'asc'); ?>');
                        spider_form_submit(event, 'spider_twitt_form')" href="">
          ...
          <th class="table_big_col <?php if ($order_by == 'published') {echo $order_class;} ?>">
            <a onclick="spider_set_input_value('task', '');
                        ...
                        spider_set_input_value('asc_or_desc', '<?php echo (( WDWTILibrary::get('order_by','') == 'published' && WDWTILibrary::get('asc_or_desc') == 'asc') ? 'desc' : 'asc'); ?>');
						spider_form_submit(event, 'spider_twitt_form')" href="">
