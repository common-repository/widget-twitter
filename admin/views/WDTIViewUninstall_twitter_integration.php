...
<!--      <p><strong><a href="<?php /*echo $deactivate_url; */?>">Click Here</a> To Finish the Uninstallation and Widget Twitter will be Deactivated Automatically.</strong></p>-->
          <p><strong><a href="#" class="wdti_deactivate_link" data-uninstall="1"><?php _e("Click Here","wdti"); ?></a><?php _e(" To Finish the Uninstallation and Team WD will be Deactivated Automatically.","wdti"); ?></strong></p>
